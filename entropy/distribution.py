...
def calculate_distribution(inf_sources=[string.ascii_lowercase + ' '], mapping=lambda a: ord(a), order=1, words=False, words_separator=" "):
    ...
    #inf_sources will be basically an array of songs in that case
    for inf_source in inf_sources:
        if words:
